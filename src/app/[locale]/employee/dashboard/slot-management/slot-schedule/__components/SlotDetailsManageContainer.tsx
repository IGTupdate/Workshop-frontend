  ...
  return (
    <div className="w-full">
      ...
      {fields.map((slot_details, index) => {
        return (
          <div key={slot_details.id} className="mb-8">
            <div className="flex justify-between items-center mb-2">
              <Typography className="p-2 py-1 font-semibold bg-yellow-100 border rounded-lg inline-block">
                Slot : {index + 1}
              </Typography>
            ...
            <div className="mb-4">
              ...
              <Row gutter={16}>
                <Col span={12}>
                  <label className="mb-2 block text-black1" htmlFor="name">
                    Hour
                  </label>
                  <Controller
                  ...
                  />
                  {props.errors?.slot_details && (
                    <span className="text-xs text-red-500">
                      {
                        props.errors?.slot_details[index]?.start_time?.hour
                          ?.message
                      }
                    </span>
                  )}
                ...
                <Col span={12}>
                  ...
                  />
                  {props.errors?.slot_details?.[index]?.start_time?.minute && (
                    <span className="text-xs text-red-500">
                      {
                        props.errors?.slot_details[index]?.start_time.minute
                          ?.message
            ...
            <Row className="w-full">
              <label className="font-semibold mb-2" htmlFor="Limit">
                Limit
              </label>
              <Controller
