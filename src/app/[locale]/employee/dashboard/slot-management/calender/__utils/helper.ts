...
export const toogleCalenderStatus = (
  currentStatus: TCalenderStatus,
): TCalenderStatus => {
  const changeStatusTo =
    currentStatus === calender_status.open
      ? (calender_status.close as TCalenderStatus)
      : (calender_status.open as TCalenderStatus);
