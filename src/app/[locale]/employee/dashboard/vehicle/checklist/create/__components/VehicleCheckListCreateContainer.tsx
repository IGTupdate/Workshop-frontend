...
// import { TvehicleCheckListCreateYupSchema, vehicleCheckListCreateYupSchema } from "@/app/validators/vehicle-checklist";
...
// const VehicleCheckListCreateContainer = (props: Props) => {
...
//   const {
//     control, handleSubmit, formState: { errors }, setValue, getValues, } = useForm({
//       defaultValues: {
...
//               onClick={() => { removeValueInArray("checklist", index) }}
//             >
...
//                 error=""
//                 mode="single"
//                 options={[{ label: "Car", value: vehicleTypeEnum.CAR }, { label: "Truch", value: vehicleTypeEnum.TRUCK }]}
...
// export default VehicleCheckListCreateContainer;
...
import toast from "react-hot-toast";
import VehicleCheckListManageContainer from "../../[vehicleChecklistId]/__components/VehicleCheckListManageContainer";
...
const VehicleCheckListCreateContainer = (props: Props) => {
  ...
  return (
    <div>
      <VehicleCheckListManageContainer handleOnSave={onSubmit} />
    </div>
  );
};
