  ...
  return (
    <div className="container w-full relative py-16 md:pt-32 xmd:pt-44 xl:py-24 pb-16">
      <Image
        ...
        alt="left"
        className="absolute top-0 left-0 w-16 h-16 md:w-[100.77px] md:h-[125.56px] xmd:w-[140.77px] xmd:h-[165.56px] opacity-60"
      />
      <Image
        fill={true}
        src={"/images/right.webp"}
        alt="right"
        className="absolute top-0 left-auto !right-0 w-16 h-16 md:w-[100.77px] md:h-[125.56px] xmd:w-[140.77px] xmd:h-[165.56px] opacity-60"
      />
      <div>
