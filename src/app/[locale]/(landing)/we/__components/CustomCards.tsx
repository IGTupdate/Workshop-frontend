  ...
  return (
    <>
      <Image
        ...
        alt="line"
        className="absolute left-auto bottom-auto right-0 top-0 xl:top-[-203px] z-[1] h-max"
      />
      <Image
        fill
        src={"/images/line6.webp"}
        alt="line"
        className="absolute left-0 top-auto right-auto bottom-0 xl:bottom-[-250px] z-[1] h-max"
      />
