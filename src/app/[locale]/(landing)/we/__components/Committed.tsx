...
const Committed = ({ reverse, para, heading }: props) => {
  const t = useTranslations("Committed");
  return (
    <div>
      <div className="container">
        <div
          className={`flex ${reverse ? "flex-row-reverse" : "flex-row"} flex-wrap xl:flex-nowrap gap-4 xl:gap-0 justify-center xl:justify-between items-center py-6 md:py-12`}
        >
          <p
          ...
          <div
            className={`w-full xl:w-1/2 p-0 xl:ps-4 flex flex-col ${reverse ? "justify-center items-center" : "justify-center xl:justify-start items-center xl:items-start"}`}
          >
