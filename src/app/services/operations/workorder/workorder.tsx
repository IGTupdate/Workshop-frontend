import { TWorkOrderAssign, TworkOrderCreate, TworkorderPrepare } from "@/app/validators/workorder";
...
export const assignMechanicWorkorder = async (workOrderId: string, data: TWorkOrderAssign) => {
    try {
...
export const removeMechanicWorkOrder = async (workOrderId: string, data: TWorkOrderAssign) => {
    try {
        console.log(data, workOrderId);
        const response = await apiConnector({
            method: "POST",
