...
} from "@/app/store/slices/customerAppointmentSlice";
...
const {
  GET_APPOINTMENT_BY_CALENDAR,
  APPOINTMENT_BOOK,
  GET_CUSTOMER_INIT_DATA,
  GET_ALL_APPOINTMENT,
  GET_APPOINTMENT_BOOK_INIT_DATA,
  GET_ALL_CUSTOMER_APPOINTMENT,
...
export const getAppointmentByAppointmentId = async (
