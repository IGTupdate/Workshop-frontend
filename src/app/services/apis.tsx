...
const APPOINTMENT_SERVIVE_BASE_URL = "http://localhost:5000/api";
...
const APPOINTMENT_SLOT_BASE_URL = APPOINTMENT_SERVIVE_BASE_URL + SLOTS

const APPOINTMENT_SLOT_SCHEDULE_BASE_URL = APPOINTMENT_SERVIVE_BASE_URL + SLOT_SCHEDULE;
const APPOINTMENT_CALENDER_BASE_URL = APPOINTMENT_SERVIVE_BASE_URL + CALENDER;
const APPOINTMENT_BASE_URL = APPOINTMENT_SERVIVE_BASE_URL + APPOINTMENT
const APPOINTMENT_VEHICLE_BASE_URL = APPOINTMENT_SERVIVE_BASE_URL + VEHICLE;
