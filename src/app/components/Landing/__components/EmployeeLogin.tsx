  ...
  return (
    <div className="container mx-auto">
      <div className="gap-6 lg:gap-10 flex flex-wrap justify-center items-center">
        ...
        <div>
          <h1 className="text-3xl font-bold mb-4 text-center xmd:text-start">Are you an employee?</h1>
          <p className="text-lg mb-6 text-center xmd:text-start">Login to access employee features.</p>
