    ...
    useEffect(() => {
        setAppointmentRescheduleData((prv) => {
            if (props.appointment !== null) {
                return {
                    ...prv,
                    vehicle_id: (typeof props.appointment.vehicle_id === "string") ? props.appointment?.vehicle_id : props.appointment?.vehicle_id._id,
                    customer_id: (typeof props.appointment.customer_id === "string") ? props.appointment?.customer_id : props.appointment?.customer_id._id
                }
            }
            return prv;
        ...
        <div>

            {
                props.appointment ? <div>
                    ...
                    {
                        currentStep === 1 && <AppointmentRescheduleConfirmation
