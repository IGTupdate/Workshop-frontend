...
const Page = (props: Props) => {
    ...
    return (
        <>
            {loading ? <div style={{ height: 'calc(100vh - 200px)' }} className="flex justify-center items-center">
                <Loader />
            </div>
                :
                (employee ? <div className='p-4 bg-white shadow-xl rounded-xl overflow-hidden'>
                    <div className='mb-8'>
