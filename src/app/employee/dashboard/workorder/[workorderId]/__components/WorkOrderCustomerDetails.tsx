        ...
        <div>
            ...
            <Descriptions column={2}>
                ...
                <Descriptions.Item label="Phone Number">
                    {(typeof props.customer !== "string") ? props.customer.contactNumber : "-"}
                </Descriptions.Item>
                <Descriptions.Item label="Email">
                    {(typeof props.customer !== "string") ? props.customer.email : "-"}
                </Descriptions.Item>
                <Descriptions.Item label="Vehicle Reg No">
                    {(typeof props.vehicle !== "string") ? props.vehicle.registeration_number : "-"}
                </Descriptions.Item>
                ...
                <Descriptions.Item label="Model">
                    {(typeof props.vehicle !== "string") ? props.vehicle.vehicle_model : "-"}
                </Descriptions.Item>
            </Descriptions>
        </div>
    )
