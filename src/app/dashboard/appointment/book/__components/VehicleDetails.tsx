  ...
  return (
    <>
      <div className='hidden sm:block'>
        <Descriptions column={2} className='p-4 pb-0 bg-white rounded-xl shadow-xl'>
      ...
      <div className="block sm:hidden">
        <div className="p-4 bg-white rounded-xl shadow-xl">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 pb-4">
            <div className='flex items-center gap-2'><p className='text-antGreay'>Vehicle Make:</p> <p className='font-semibold text-nowrap'>{vehicleDetails.vehicle_make}</p>
            </div>
            <div className='flex items-center gap-2'><p className='text-antGreay'>Vehicle Model:</p> <p className='font-semibold text-nowrap'>{vehicleDetails.vehicle_model}</p>
            </div>
          </div>


          <div className="flex items-center justify-between flex-wrap gap-4 pb-4">
            <div className='flex items-center gap-2'><p className='text-antGreay'>VIN:</p> <p className='font-semibold text-nowrap'>{vehicleDetails.vin}</p>
            </div>
            <div className='flex items-center gap-2'><p className='text-antGreay'>Created At:</p> <p className='font-semibold text-nowrap'>{vehicleDetails.registeration_number}</p>
            </div>
          </div>


          <div className="flex items-center justify-between flex-wrap gap-4 pb-4">
            <div className='flex items-center gap-2'><p className='text-antGreay'>Owner:</p> <p className='font-semibold text-nowrap'>{vehicleDetails.owner}</p>
            </div>
            <div className='flex items-center gap-2'><p className='text-antGreay'>Registration Number:</p> <p className='font-semibold text-nowrap'>{vehicleDetails.createdAt}</p>
            </div>
          </div>
