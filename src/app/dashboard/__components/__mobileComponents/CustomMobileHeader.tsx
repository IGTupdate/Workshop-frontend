...
const CustomMobileHeader = () => {
    ...
    const items: MenuProps['items'] = [
        {
            key: '1',
            label: <Link href="/dashboard/settings" className='flex items-center gap-2 w-32'>
                <IoSettingsOutline /> Setting
            </Link>,
        },
        {
            key: '2',
            label: <p className='flex items-center gap-2 w-32' onClick={showModal}>
                < FiLogOut />Logout
            </p>,
        },
        ...
        <>
            <div className='fixed z-50 top-0 left-0 w-full bg-[#f5f5f5] p-4 flex justify-between items-center'>
                    ...
                    pathName.split("/")[2] === "notifications" ? <div>
                        ...
                        <Link href={"/dashboard"} className='text-black'>
                            <div className="heading relative">
                                ...
                                <h1 className='text-2xl font-bold capitalize'>{user?.fullName?.split(" ")[0]}</h1>
                ...
                <div className="flex justify-center items-center gap-2">
                    ...
                    <Link href={"/dashboard/profile"}><PiUserCircleFill className='text-5xl text-[#2b2c30]' /></Link>
